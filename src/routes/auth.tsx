    ...
    >
      ...
      >
        <Link to="/" className="flex items-center gap-2 mb-8">
          <img src={logo} alt="MauzoChap" className="h-12 w-auto bg-white p-2 rounded-lg shadow-sm" />
        </Link>
        <div>
      ...
      <div className="flex items-center justify-center p-6">
        <div className="w-full max-w-md rounded-2xl border border-border bg-card p-8 shadow-[var(--shadow-soft)]">
          <Link to="/" className="lg:hidden flex items-center gap-2 mb-6">
            <img src={logo} alt="MauzoChap" className="h-10 w-auto bg-white p-1.5 rounded-md shadow-sm" />
          </Link>
